...
namespace OxyPlot.Blazor
{
    ...
    /// Provides a render context for scalable vector graphics output.
    /// </summary>
    public class BlazorSvgRenderContext : RenderContextBase
    {
        /// <summary>
        /// The writer.
        /// </summary>
        private readonly RenderTreeSvgWriter w;
        ...
        public BlazorSvgRenderContext(RenderTreeSvgWriter writer)
        {
            this.w = writer;
        }
        ...
        public IRenderContext TextMeasurer => w.TextMeasurer;
